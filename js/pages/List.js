...
const roleIconMap = {  
    ...
    dev: "code",  
    trial: "user-lock",  
    reviewer: "user-magnifying-glass",  
};  
        ...
        >
            ...
            <div class="meta-container">  
                <div class="meta">  
                    ...
                    <p>  
                        <a href="https://geode-sdk.org/mods/beat.click-sound" target="_blank">Click sounds full geode mod</a> is not allowed, either show a handcam or enable microphone so click sounds are heard in pc, for mobile just show taps or again enable microphone so the clicks can be heard.  
                    </p>  
                </div>  
            </div>  
        </main>  
